...
(
  ...
  function applyTheme(theme) {
    ...
    const darkText = btn.dataset.dark;
    const lightText = btn.dataset.light;
      if (icon) icon.className = `bi ${theme === "dark" ? "bi-sun" : "bi-moon-stars"} theme-icon`;
      if (label) label.textContent = theme === "dark" ? lightText : darkText;
    });
  }
